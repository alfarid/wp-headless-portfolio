      ...
      {status === 'success' ? (
        <div className={styles.successWrapper}>
          ...
          <p className={styles.successText}>
            Terima kasih telah menghubungi saya. Saya akan segera membalas email Anda dalam waktu 1x24 jam.
          </p>
          <button 
            type="button" 
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.inputGroup}>
            <label htmlFor="service" className={styles.label}>Layanan yang Diminati</label>
            <select
              id="service"
              name="service"
            ...
            >
              ...
              <option value="optimization">Speed & Core Web Vitals Optimization</option>
              <option value="other">Lainnya / Konsultasi Umum</option>
            </select>
          </div>

          <div className={styles.inputGroup}>
            <label htmlFor="message" className={styles.label}>Detail Project / Pesan</label>
            <textarea
              id="message"
              name="message"
          ...
          {status === 'error' && (
            <div className={styles.errorContainer}>
              Terjadi kesalahan. Silakan coba lagi atau kirim email langsung ke hello@wpdev.com.
            </div>
          )}
