      ...
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '60px' }} data-aos="fade-up">
          ...
          <p className="section-subtitle">
            Menggabungkan kebebasan manajemen konten WordPress dengan performa dan kecepatan Next.js untuk hasil bisnis yang maksimal.
          </p>
        </div>
            ...
            >
              ...
              <div className={styles.arrowIcon} aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="9" height="8" fill="none">
                  <path fill="#8E9AAB" d="m4.92 8-.787-.763 2.733-2.68H0V3.443h6.866L4.133.767 4.92 0 9 4 4.92 8Z"></path>
                </svg>
              </div>
        ...
        <div style={{ marginTop: '50px', textAlign: 'center' }} data-aos="fade-up">
          <a href="#contact" className="btn btn-primary">Konsultasi Sekarang</a>
        </div>
      </div>
    </section>
  );
