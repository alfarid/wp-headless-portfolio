...
const Blog = ({ items }: BlogProps) => {
  return (
    <section id="blog" className="section" style={{ backgroundColor: 'transparent' }}>
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '60px' }} data-aos="fade-up">
          ...
          <p className="section-subtitle">
            Tutorial pengembangan headless WordPress, arsitektur decoupled, dan berita seputar dunia web development.
          </p>
        </div>
        
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px' }}>
          {items.map((blog, idx) => (
            <div key={blog.id} className="glass-panel spotlight-card" data-aos="fade-up" data-aos-delay={idx * 150} style={{ cursor: 'pointer', overflow: 'hidden', display: 'flex', flexDirection: 'column', height: '100%' }}>
              ...
              <div style={{ padding: '25px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                ...
                <span style={{ color: 'var(--primary)', fontWeight: '600', fontSize: '0.85rem', marginTop: '20px', display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
