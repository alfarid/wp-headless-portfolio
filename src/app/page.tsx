    ...
    >
        ...
        <div className="container" style={{ position: "relative", zIndex: 10 }}>
          ...
          >
            ...
            <div data-aos="fade-left" data-aos-delay="100">
              ...
              >
                Saya adalah Web Developer yang fokus pada pengembangan modern
                menggunakan arsitektur **headless wordpress nextjs**. Saya
                percaya bahwa admin konten berhak mendapatkan kemudahan
                dashboard WordPress, sementara pengunjung website berhak
                mendapatkan kecepatan loading milidetik dari Next.js.
              </p>
              <p
                style={{
                  fontSize: "1.1rem",
              ...
              >
                Dengan keahlian di bidang custom plugin, custom Gutenberg block
                development, serta GraphQL API, saya mengubah WordPress
                tradisional Anda menjadi aplikasi web modern yang dinamis dan
                berkinerja tinggi.
              </p>
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 10 }}>
          ...
          >
            {/* Feature 1 - WordPress Headless Next.js */}
      ...
      >
        <div className="container" style={{ textAlign: "center" }}>
          ...
          >
            Hubungi saya sekarang untuk mendiskusikan migrasi website ke
            headless Next.js, pembuatan plugin kustom, atau optimasi speed
